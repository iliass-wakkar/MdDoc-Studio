' MdDoc Desktop GUI Silent Launcher (No Terminal Window)
' Double-click this file to launch the native desktop GUI without any console window.
...
WshShell.Run """" & pythonwPath & """ """ & strCurDir & "\mddoc\gui.py""", 0, False
