...
Built with CustomTkinter for a sleek, modern Windows 11 / macOS dark & light interface.
Non-resizable fixed pixel-perfect layout with sidebar navigation, live editor, custom theme designer, and developer profile.
"""
...
class MdDocModernApp(ctk.CTk):
    ...
    def _create_layout(self):
        ...
        self.grid_columnconfigure(0, weight=0)  # Fixed sidebar width
